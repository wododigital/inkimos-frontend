...
const Partner = () => {
  return (
    <section className="bg-service py-12">
      <div className="max-w-[1440px] mx-auto px-5 sm:px-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col justify-center text-left">
          ...
          <p className="text-base sm:text-[26px] font-medium text-white mb-3 md:mb-6">
        ...
        <div className="flex justify-center items-center relative">
          {/* Video */}
          <video
            className="w-full sm:w-[90%] lg:w-[1000px] h-[300px] sm:h-[500px] md:h-[600px] rounded-lg object-cover"
            autoPlay
            muted
            loop
          >
          ...
          {/* Buttons on Video */}
          <div className="absolute top-16 left-4 sm:left-8 md:left-12 z-10">
          ...
          <div className="absolute center right-12 md:right-4  z-10">
            <button className="bg-black border border-green text-white px-4 py-2 rounded-xl text-xs sm:text-base">
              <Link to="/contact">End-to-End Support</Link>
            </button>
          </div>
          <div className="absolute bottom-16 left-4 sm:left-8 md:left-12 z-10">
            <button className="bg-black border border-green text-white px-4 py-2 rounded-xl text-xs sm:text-base">
