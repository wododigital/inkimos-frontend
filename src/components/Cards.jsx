      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 animate-slide-in-top translate-y-[60%]">
        {cardData.map((card, index) => (
          <div
            ...
            className="bg-darkBlue rounded-3xl p-10 hover:scale-105 hover:bg-dblack card-initial"
          >
            <div className="min-h-[94px]">
              <h3 className="text-[26px] font-medium mb-4 text-white max-w-[340px]">{card.title}</h3>
            </div>
