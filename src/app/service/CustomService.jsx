...
const CustomService = () => {
  ...
  <div className="bg-black min-h-[450px] w-full flex items-center justify-center flex-col text-center relative">
    <img src={Cusbg1} alt="Circle1 image" className="absolute right-0 top-0 w-[100px] h-[225px] md:w-[190px] md:h-[300px]" />
    <img src={Cusbg} alt="Circle2 image" className="absolute left-[-0px] md:bottom-[-50px] w-[200px] bottom-0 md:w-[200px] h-auto" />
