  ...
  return (
    <>
      ...
      <section className="max-w-[1440px] mx-auto px-5 lm:px-12">
        <div className="grid grid-cols-1 gap-5 md:gap-20 py-10 md:py-[100px]">
          {industries.map((industry, index) => (
            <div className="" key={index}>
              <div
                className={`flex flex-col md:gap-8 items-center bg-white rounded-3xl overflow-hidden border-2 border-green ${index % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"
                  }`}
              >
